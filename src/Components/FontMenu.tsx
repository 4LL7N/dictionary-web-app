...
function FontMenu() {
  ...
  return (
    <>
      <div className={` flex flex-col justify-between w-[183px] h-[152px] rounded-[16px] p-[24px] ${context?.theme?"bg-[#FFF] shadow-[0_5px_30px_0px_#00000019] ":"bg-[#1F1F1F] shadow-[0_5px_30px_0_#A445ED] "} ${context?.fontMenu?"":"hidden"} absolute top-[65px] left-[70px]  `}>
